...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'wujae@sebastien69.onmicrosoft.com',
  ...
  email: 'mailto:wujae@sebastien69.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Sebastien-69/onedrive-vercel-index',
    },
  ],
